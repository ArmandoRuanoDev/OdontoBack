...
import { sendAccountBlockedAlert } from '../services/emailService';
...
async function testEmail() {
    try {
        ...
        await sendAccountBlockedAlert(email, username, 10, 5, new Date());
...
// npx ts-node scripts/accountBlockedAlert.test.ts