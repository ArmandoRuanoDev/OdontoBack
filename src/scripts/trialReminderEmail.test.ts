...
import { sendTrialEndingReminderEmail } from '../services/emailService';
...
async function testEmail() {
    try {
        ...
        await sendTrialEndingReminderEmail(email, username, 'Prueba', new Date(), 299, 'MXN', '2498')
...
// npx ts-node scripts/trialReminderEmail.test.ts